...
module.exports = {
  ...
  'Should clone a repository #group2': function (browser: NightwatchBrowser) {
    browser
      ...
      .setValue('[data-id="modalDialogCustomPromptTextClone"]', 'https://github.com/openibank/forge')
      .click('[data-id="topbarModal-modal-footer-ok-react"]')
      .waitForElementPresent('.fa-spinner')
      .waitForElementVisible('*[data-id="treeViewLitreeViewItem.git"]')
      .waitForElementContainsText('[data-id="workspacesSelect"]', 'forge')
  },
  ...
  'Should display non-clashing names for duplicate clone #group2': '' + function (browser: NightwatchBrowser) {
    browser
      ...
      .click('[data-id="topbarModal-modal-footer-ok-react"]')
      .pause(5000)
      .waitForElementContainsText('[data-id="workspacesSelect"]', 'forge1')
      .waitForElementVisible('*[data-id="github-dropdown-toggle"]')
      .click('*[data-id="github-dropdown-toggle"]')
      .waitForElementVisible('*[data-id="github-dropdown-item-clone"]')
      .click('*[data-id="github-dropdown-item-clone"]')
      ...
      .click('[data-id="topbarModal-modal-footer-ok-react"]')
      .pause(5000)
      .waitForElementContainsText('[data-id="workspacesSelect"]', 'forge2')
      .waitForElementVisible('*[data-id="github-dropdown-toggle"]')
      .click('*[data-id="github-dropdown-toggle"]')
      .waitForElementVisible('*[data-id="github-dropdown-item-clone"]')
      .click('*[data-id="github-dropdown-item-clone"]')
      ...
      .click('[data-id="topbarModal-modal-footer-ok-react"]')
      .pause(5000)
      .waitForElementContainsText('[data-id="workspacesSelect"]', 'forge3')
      .switchWorkspace('forge')
      .switchWorkspace('forge1')
      .switchWorkspace('forge2')
      .switchWorkspace('forge3')
  },
