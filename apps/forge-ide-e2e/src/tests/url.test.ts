...
module.exports = {
  ...
  'Should load the code from URL params (url param) #group1': function (browser: NightwatchBrowser) {
    browser
      ...
      .url('http://127.0.0.1:8080/#optimize=true&runs=300&url=https://github.com/openibank/forge/blob/master/apps/forge-ide/contracts/app/solidity/mode.sol')
      .refreshPage() // we do one reload for making sure we already have the default workspace
      .waitForElementVisible({
        selector: `//li[@data-id="treeViewLitreeViewItemopenibank/forge/apps/forge-ide/contracts/app/solidity/mode.sol"]`,
  ...
  'Should load the code from URL & code params #group1': function (browser: NightwatchBrowser) {
    browser
      .url('http://127.0.0.1:8080/#optimize=true&runs=300&url=https://github.com/openibank/forge/blob/master/apps/forge-ide/contracts/app/solidity/mode.sol&code=')
      .refreshPage() // we do one reload for making sure we already have the default workspace
  ...
  'Import Github folder from URL params #group4': function (browser: NightwatchBrowser) {
    browser
      .url('http://127.0.0.1:8080/#ghfolder=https://github.com/openibank/forge/tree/master/apps/forge-ide/contracts/hardhat')
      .refreshPage()
