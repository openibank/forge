...
module.exports = {
  ...
  'clone a repository #group1': function (browser: NightwatchBrowser) {
    browser
      ...
      .waitForElementVisible({
        selector: '//*[@data-id="clone-panel-content"]//*[contains(text(), "forge")]',
        locateStrategy: 'xpath'
      })
      .click({
        selector: '//*[@data-id="clone-panel-content"]//*[contains(text(), "forge")]',
      ...
      .waitForElementVisible({
        selector: '//*[@data-id="clone-panel-content"]//*[@data-id="clonebtn-openibank/forge-master"]',
        locateStrategy: 'xpath'
      })
      .click({
        selector: '//*[@data-id="clone-panel-content"]//*[@data-id="clonebtn-openibank/forge-master"]',
  ...
  'add a remote #group2': function (browser: NightwatchBrowser) {
    browser
      ...
      .waitForElementVisible({
        selector: '//*[@data-id="remotes-panel-content"]//*[contains(text(), "forge")]',
        locateStrategy: 'xpath'
      })
      .click({
        selector: '//*[@data-id="remotes-panel-content"]//*[contains(text(), "forge")]',
  ...
  'clone repo #group3': function (browser: NightwatchBrowser) {
    browser
      ...
      .setValue('*[data-id="clone-url"]', 'https://github.com/openibank/forge')
