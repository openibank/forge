...
module.exports = {
  ...
  'Should resolve url #group4': async function (browser: NightwatchBrowser) {
    await clickAndCheckLog(browser, 'contentImport-resolve', '# Forge Project', null, 'https://github.com/openibank/forge/blob/master/README.md')
  },
  'Should resolve and save url #group4': async function (browser: NightwatchBrowser) {
    await clickAndCheckLog(browser, 'contentImport-resolveAndSave', '# Forge Project', { event: 'fileAdded', args: ['.deps/github/openibank/forge/README.md']}, 'https://github.com/openibank/forge/blob/master/README.md')
  },
  // UNIT TESTING
