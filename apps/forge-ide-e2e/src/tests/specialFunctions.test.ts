...
module.exports = {
  ...
  before: function (browser: NightwatchBrowser, done: VoidFunction) {
    // this test suite also contribute testing https://github.com/ethereum/remix/pull/1497 and https://github.com/ethereum/forge-ide/pull/2898
    // quick explanation:
    // the goal of https://github.com/ethereum/forge-ide/pull/2898 is to keep track of all the compiled contracts a not only the last one.
