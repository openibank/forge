...
echo "$listJson" > ./apps/forge-ide/src/assets/list.json
...
if [ ! -d "./apps/forge-ide/src/assets/js/soljson" ]; then
    mkdir -p ./apps/forge-ide/src/assets/js/soljson
fi

# Download the soljson.js file to ./apps/forge-ide/src/assets/js/soljson.js
echo "Downloading soljson.js from $fullPath to ./apps/forge-ide/src/assets/js/soljson.js"
curl -s "$fullPath" > ./apps/forge-ide/src/assets/js/soljson.js

# Copy the downloaded soljson.js to the specific version directory
cp ./apps/forge-ide/src/assets/js/soljson.js "./apps/forge-ide/src/assets/js/soljson/$defaultVersion.js"
