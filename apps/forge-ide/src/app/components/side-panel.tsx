...
import { ForgeUIPanelHeader } from '@creditchain/forge-ui/panel'
...
export class SidePanel extends AbstractPanel {
  ...
  updateComponent(state: any) {
    return <ForgePluginPanel header={<ForgeUIPanelHeader plugins={state.plugins} pinView={this.pinView.bind(this)} unPinView={this.unPinView.bind(this)}></ForgeUIPanelHeader>} plugins={state.plugins} pluginState={state.pluginState} />
  }
