...
import { ForgeUiPluginManager } from '@creditchain/forge-ui/plugin-manager' // eslint-disable-line
...
export class PluginManagerComponent extends ViewPlugin {
  ...
  constructor (appManager: ForgeAppManager, engine: RemixEngine) {
    super(profile)
   ...
   * ForgeAppManager to enable plugin activation
   * @param {string} name name of Plugin
   */
  activateP = (name) => {
  ...
  updateComponent(state){
    return <ForgeUiPluginManager pluginComponent={state} />
  }
