...
import { ForgeUIGridView } from '@creditchain/forge-ui/grid-view'
import { ForgeUIGridSection } from '@creditchain/forge-ui/grid-section'
import { ForgeUIGridCell } from '@creditchain/forge-ui/grid-cell'
import * as Data from './forgeGuideData.json'
import './forgeGuide.css'

const profile = {
  name: 'forgeGuide',
  displayName: 'Forge Guide',
  description: 'Learn CreditChain and EVM development using Forge with videos.',
  location: 'mainPanel',
...
export class ForgeGuidePlugin extends ViewPlugin {
  ...
  constructor(appManager: ForgeAppManager) {
    ...
    this.element.setAttribute('id', 'forgeGuideEl')
    this.payload = {
  ...
  async onActivation() {
    ...
    await this.call('tabs', 'focus', 'forgeGuide')
    this.renderComponent()
    trackMatomoEvent(this, { category: 'plugin', action: 'activated', name: 'forgeGuide', isClick: true })
    // Read the data
  ...
  render() {
    return (
      <div className="bg-dark" id="forgeGuide">
              ...
              { section.cells.map((cell, index) => {
                return <ForgeUIGridCell
                  ...
                  handleExpand={() => {
                    ...
                    this.renderComponent()
                    trackMatomoEvent(this, { category: 'forgeGuide', action: 'playGuide', name: cell.title, isClick: true })
                  }}
                >
                  <img
