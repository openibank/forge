...
import { AlertModal, AppModal } from '@creditchain/forge-ui/app'
...
import type { Template, TemplateGroup } from '@creditchain/forge-ui/workspace'
      ...
      >
        {
          templates(window._intl, this).map(template => {
            ...
            >
              ...
              {template.name === 'Cookbook' && <ForgeUIGridCell
                // plugin={this}
