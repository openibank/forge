...
import { ChatCommandParser, GenerationParams, ChatHistory, HandleStreamResponse, AIModel, ANONYMOUS_FALLBACK_MODELS, aiErrorFromException, remixAILogger } from '@creditchain/forge-ai-core'
import { ToolApprovalRequest, ApiKeyErrorEvent } from '@creditchain/forge-ai-core'
import { HandleOpenAIResponse, HandleMistralAIResponse, HandleAnthropicResponse, HandleOllamaResponse } from '@creditchain/forge-ai-core'
//@ts-ignore
import '../css/color.css'
import { ModalTypes } from '@creditchain/forge-ui/app'
import { MatomoEvent, AIEvent, Features, PublicPlan, ChatPromptMetadata } from '@creditchain/forge-api'
//@ts-ignore
...
import { RemixAIAssistant } from 'apps/forge-ide/src/app/plugins/remix-ai-assistant'
...
export interface ForgeUiRemixAiAssistantProps {
...
export interface ForgeUiRemixAiAssistantHandle {
...
export const ForgeUiRemixAiAssistant = React.forwardRef<
  ForgeUiRemixAiAssistantHandle,
  ForgeUiRemixAiAssistantProps
>(function ForgeUiRemixAiAssistant(props, ref) {
