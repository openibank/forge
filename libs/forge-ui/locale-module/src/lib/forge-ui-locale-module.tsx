...
import './forge-ui-locale-module.module.css'

export interface ForgeUiLocaleModuleProps {
  localeModule: LocaleModule
}

export function ForgeUiLocaleModule({ localeModule }: ForgeUiLocaleModuleProps) {
...
export default ForgeUiLocaleModule
