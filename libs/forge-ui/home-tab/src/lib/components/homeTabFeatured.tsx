...
function HomeTabFeatured(props:HomeTabFeaturedProps) {
  ...
  const handleStartForgeGuide = async () => {
    trackMatomoEvent({
      category: 'hometab',
      action: 'featuredSection',
      name: 'watchOnForgeGuide',
      isClick: true
    })
    await props.plugin.appManager.activatePlugin(['forgeGuide'])
    await props.plugin.call('tabs', 'focus', 'forgeGuide')
  }
  return (
        ...
        <div className="w-100 d-flex flex-column rounded-3 remix_ui-carouselbox">
          <ThemeContext.Provider value={themeFilter}>
            ...
            >
              ...
              <div className="me-1 pe-1 d-flex align-items-center justify-content-center h-100">
                <button className="btn" onClick={() => handleStartForgeGuide()}>
