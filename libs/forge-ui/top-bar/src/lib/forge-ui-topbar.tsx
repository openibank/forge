...
import { CustomToggle } from 'libs/forge-ui/helper/src/lib/components/custom-dropdown'
import { WorkspaceMetadata } from 'libs/forge-ui/workspace/src/lib/types'
import { CloudToggle } from 'libs/forge-ui/workspace/src/lib/cloud/cloud-sync-status-icon'
import { enableCloud, disableCloud } from 'libs/forge-ui/workspace/src/lib/cloud/cloud-workspace-actions'
import { cloudStore } from 'libs/forge-ui/workspace/src/lib/cloud/cloud-store'
import { AppContext, platformContext } from 'libs/forge-ui/app/src/lib/forge-app/context/context'
import { useAuth } from 'libs/forge-ui/app/src/lib/forge-app/context/auth-context'
import { FormattedMessage, useIntl } from 'react-intl'
import { TopbarContext } from '../context/topbarContext'
import { WorkspacesDropdown } from '../components/WorkspaceDropdown'
import { useOnClickOutside } from 'libs/forge-ui/remix-ai-assistant/src/components/onClickOutsideHook'
import { deleteWorkspace, fetchWorkspaceDirectory, deleteAllWorkspaces as deleteAllWorkspacesAction, handleDownloadFiles, handleDownloadWorkspace, handleExpandPath, publishToGist, renameWorkspace, restoreBackupZip, switchToWorkspace } from 'libs/forge-ui/workspace/src/lib/actions'
...
import { CustomTooltip } from 'libs/forge-ui/helper/src/lib/components/custom-tooltip'
...
import { MatomoEvent, TopbarEvent, WorkspaceEvent, LoginMode, LoginModeResponse, Features } from '@creditchain/forge-api'
import { LoginButton } from '@creditchain/forge-ui/login'
import { LoginModal } from 'libs/forge-ui/login/src/lib/modals/login-modal'
