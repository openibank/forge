...
import { DISCORD_URL, TWITTER_URL, YOUTUBE_URL, SUBSTACK_URL } from '@creditchain/forge-ui/helper'
    ...
    <>
      ...
      <div className="hm-popover" role="menu" aria-label="Help and resources">
        ...
        <section className="hm-section">
          ...
          <a className="hm-row" href={`${CREDITFORGE_LINKS.home}/?#activate=forgeGuide`} target="_blank" rel="noreferrer">
