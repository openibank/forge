...
import './forge-ui-grid-section.css'
...
interface ForgeUIGridSectionProps {
  plugin: any
  title?: string
  tooltipTitle?: string
  hScrollable: boolean
...
export const ForgeUIGridSection = (props: ForgeUIGridSectionProps) => {
...
export default ForgeUIGridSection
