...
import './forge-ui-grid-view.css'
import CustomCheckbox from './components/customCheckbox'
import FiltersContext from "./filtersContext"
import { MatomoEvent, GridViewEvent } from '@creditchain/forge-api'
import { TrackingContext } from '@creditchain/forge-ide/tracking'

interface ForgeUIGridViewProps {
  plugin: any
  logo?: string
  title?: string
...
export const ForgeUIGridView = (props: ForgeUIGridViewProps) => {
...
export default ForgeUIGridView
