...
```tsx
import { DesktopDownload } from '@creditchain/forge-ui/desktop-download'
...
- React 18+
- @creditchain/forge-ui/helper (for CustomTooltip)
...
- `apps/forge-ide/src/app/tabs/locales/en/desktopDownload.json` - All translation keys for the component
