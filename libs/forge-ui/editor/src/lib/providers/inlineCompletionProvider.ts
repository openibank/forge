...
import { EditorUIProps, monacoTypes } from '@creditchain/forge-ui/editor';
import { CompletionParams } from '@creditchain/forge-ai-core';
import { trackMatomoEvent, AIEvent, MatomoEvent } from '@creditchain/forge-api'
