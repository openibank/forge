...
import { fileDecoration } from '@creditchain/forge-ui/file-decorators'
...
export type WorkspaceTemplate = 'gist-template' | 'code-template' | 'remixDefault' | 'blank' | 'ozerc20' | 'zeroxErc20' | 'ozerc721' | 'ozerc1155' | 'playground' | 'semaphore' | 'hashchecker' | 'rln' | 'breakthroughLabsUniswapv4Hooks' | 'uniswapV4Template' | 'uniswapV4HookBookMultiSigSwapHook' | 'multNr' | 'stealthDropNr' | 'creditScoreRegistry' | 'creditERC20' | 'creditPayment' | 'creditForgeLifecycle'
