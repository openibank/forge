...
import { PluginViewWrapper, DISCORD_URL, FORGE_DOCS_URL, SUBSTACK_URL } from '@creditchain/forge-ui/helper'
import { useAuth } from '@creditchain/forge-ui/app'
import { trackMatomoEvent as baseTrackMatomoEvent, HelpEvent, MatomoEvent, Features } from '@creditchain/forge-api'
    ...
    case 'beta-info':
      return <BetaWelcomeModal open onClose={onClose}
        ...
        onLink={(link) => {
          ...
          case 'docs': window.open(FORGE_DOCS_URL, '_blank'); break
          case 'blog': window.open(SUBSTACK_URL, '_blank'); break
          }
        }}
      />
    case 'free-guide':
