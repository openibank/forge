import { fileDecoration, FileDecorationIcons } from '@creditchain/forge-ui/file-decorators'
...
import { desktopConnectionType, Features } from '@creditchain/forge-api'
import isElectron from 'is-electron'
import { CompileDropdown, RunScriptDropdown, EmptyDropdown, AmpSqlDropdown } from '@creditchain/forge-ui/tabs'
// eslint-disable-next-line @nrwl/nx/enforce-module-boundaries
import TabProxy from 'apps/forge-ide/src/app/panels/tab-proxy'
...
(async () => {
  ...
  return (
    <>
      <div
        className={`forge-ui-tabs justify-content-between  border-0 header nav-tabs ${
        ...
        <div className="d-flex flex-row" style={{ maxWidth: 'fit-content', width: '99%' }}>
          <div className="d-flex flex-row justify-content-center align-items-center m-1 mt-1">
                      ...
                      tooltipText={
                        <span>
                          {tabsState.currentExt === 'js' || tabsState.currentExt === 'ts' ? (
                            <FormattedMessage id="forgeUiTabs.tooltipText1" />
                          ) : tabsState.currentExt === 'sol' || tabsState.currentExt === 'yul' || tabsState.currentExt === 'circom' || tabsState.currentExt === 'vy' ? (
                            <FormattedMessage id="forgeUiTabs.tooltipText2" />
                          ) : (
                            <FormattedMessage id="forgeUiTabs.tooltipText3" />
                          )}
                        </span>
                      }
                    >
            ...
            <div className="d-flex border-start ms-1 align-items-center" style={{ height: "3em" }}>
              <CustomTooltip placement="bottom" tooltipId="overlay-tooltip-zoom-out" tooltipText={<FormattedMessage id="forgeUiTabs.zoomOut" />}>
              ...
              <CustomTooltip placement="bottom" tooltipId="overlay-tooltip-run-zoom-in" tooltipText={<FormattedMessage id="forgeUiTabs.zoomIn" />}>
