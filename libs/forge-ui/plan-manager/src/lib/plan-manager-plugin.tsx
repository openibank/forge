...
import { PluginViewWrapper, DISCORD_URL } from '@creditchain/forge-ui/helper'
// Paddle singleton lives next to this plugin now — `@creditchain/forge-ui/billing` was
...
import type { CreditsUsageQuery, FeatureGroup, UsageReport } from '@creditchain/forge-api'
import { Features, FEATURE_LABELS, trackMatomoEvent } from '@creditchain/forge-api'
import type { CheckoutEvent } from '@creditchain/forge-api'
...
import { LoginModal, startSignInFlow, OtpDigitInput, OtpDigitInputHandle } from '@creditchain/forge-ui/login'
...
export class PlanManagerPlugin extends ViewPlugin {
  ...
  // ./paddle-singleton (formerly @creditchain/forge-ui/billing).
