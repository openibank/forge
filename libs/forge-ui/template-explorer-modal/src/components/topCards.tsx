...
import { useCloneRepositoryModal } from 'libs/forge-ui/top-bar/src/components/CloneRepositoryModal'
import { platformContext } from 'libs/forge-ui/app/src/lib/forge-app/context/context'
import { ContractWizardAction, TemplateExplorerWizardAction } from '../../types/template-explorer-types'
import { createWorkspace, switchToWorkspace, uploadFile, uploadFolder, uploadFolderExcludingRootFolder } from 'libs/forge-ui/workspace/src/lib/actions/workspace'
import { getErc20ContractCode } from '../utils/contractWizardUtils'
import { MatomoCategories, TemplateExplorerModalEvent, MatomoEvent } from '@creditchain/forge-api'
import { useOnClickOutside } from 'libs/forge-ui/remix-ai-assistant/src/components/onClickOutsideHook'
import { createNewFile } from 'libs/forge-ui/workspace/src/lib/actions'
