...
import { TerminalContext } from '@creditchain/forge-ui/terminal';
import { createTerminal } from '@creditchain/forge-ui/xterm';
import React, { useState, useEffect, useRef, useContext } from 'react' // eslint-disable-line
import { Dropdown, ButtonGroup } from 'react-bootstrap';
import { FormattedMessage } from 'react-intl';
import { ForgeUiTerminalProps } from "../../../../terminal/src/lib/types/terminalTypes";

export const ForgeUIXtermMenu = (props: ForgeUiTerminalProps) => {
