...
import ForgeUiXterm from './forge-ui-xterm'
...
import { ForgeUiTerminal, TerminalContext } from '@creditchain/forge-ui/terminal'
import { FormattedMessage } from 'react-intl'
import { xtermState } from '../types'
import { createTerminal } from '@creditchain/forge-ui/xterm'
export interface ForgeUiXterminalsProps {
  plugin: ElectronPlugin
  onReady: (api: any) => void
}

export const ForgeUiXterminals = (props: ForgeUiXterminalsProps) => {
