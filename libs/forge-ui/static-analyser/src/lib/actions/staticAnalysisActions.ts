...
import { AnalysisTab, ForgeUiStaticAnalyserReducerActionType, ForgeUiStaticAnalyserState, SolHintReport, SlitherAnalysisResults } from '../../staticanalyser'
import { ForgeUiStaticAnalyserProps } from '@creditchain/forge-ui/static-analyser'
...
export const compilation = (analysisModule: AnalysisTab,
  dispatch: React.Dispatch<ForgeUiStaticAnalyserReducerActionType>) => {
  if (analysisModule) {
    analysisModule.on(
      'solidity',
      'compilationFinished',
 ...
 * @param state { ForgeUiStaticAnalyserState}
 * @param props {ForgeUiStaticAnalyserProps}
