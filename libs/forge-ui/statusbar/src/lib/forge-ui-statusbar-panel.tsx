...
import { AppContext, appPlatformTypes, platformContext } from '@creditchain/forge-ui/app'
import { DesktopStatus } from './components/desktopStatus'
import { desktopConnectionType } from '@creditchain/forge-api'

export interface ForgeUIStatusBarProps {
...
export function ForgeUIStatusBar({ statusBarPlugin }: ForgeUIStatusBarProps) {
