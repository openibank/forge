...
import './forge-ui-skills-explorer-modal.css'
...
export interface ForgeUiSkillsExplorerModalProps {
  isOpen: boolean
  onClose: () => void
...
export function ForgeUiSkillsExplorerModal(props: ForgeUiSkillsExplorerModalProps) {
