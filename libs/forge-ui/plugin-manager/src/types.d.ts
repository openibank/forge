...
import { IframeReactPlugin } from '@creditchain/forge-ui/app'
...
export class ForgeAppManager extends PluginManager {
  constructor()
  event: EventEmitter
...
export class PluginManagerComponent extends ViewPlugin implements PluginBase {
  constructor(appManager: ForgeAppManager, engine: Engine)
...
export interface ForgeUiPluginManagerProps {
  pluginComponent: PluginManagerComponent
