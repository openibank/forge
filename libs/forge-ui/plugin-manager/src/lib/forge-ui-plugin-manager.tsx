...
import { ForgeUiPluginManagerProps } from '../types'
import PluginCard from './components/PluginCard'
import RootView from './components/rootView'
import './forge-ui-plugin-manager.css'
...
export const ForgeUiPluginManager = ({ pluginComponent }: ForgeUiPluginManagerProps) => {
