...
export interface ForgeUiSolidityUmlGenProps {
  updatedSvg?: string
  loading?: boolean
...
let umlCopy = ''
export function ForgeUiSolidityUmlGen({ updatedSvg, loading, fileName, themeDark }: ForgeUiSolidityUmlGenProps) {
...
export default ForgeUiSolidityUmlGen
