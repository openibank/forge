...
import { EtherscanConfigDescription, GitHubCredentialsDescription, SindriCredentialsDescription, TheGraphConfigDescription } from '@creditchain/forge-ui/helper'
import { AppConfig, FeatureGroup } from '@creditchain/forge-api'
import { AppContext, useAuth } from '@creditchain/forge-ui/app'
...
import { ThemeModule } from '@creditchain/forge-ui/theme-module'
import { ThemeContext, themes } from '@creditchain/forge-ui/home-tab'
import { FormattedMessage, useIntl } from 'react-intl'
import { Registry, QueryParams } from '@creditchain/forge-lib'
import { SettingsSectionUI } from './settings-section'
import { SettingsSection } from '../types'
import './forge-ui-settings.css'

/* eslint-disable-next-line */
export interface ForgeUiSettingsProps {
  plugin: ViewPlugin
  config: any
  editor: any
  _deps: any
...
export const ForgeUiSettings = (props: ForgeUiSettingsProps) => {
