...
import { ForgeUiTerminalProps, SET_OPEN } from '../types/terminalTypes'
import './forge-ui-terminal-menu-buttons.css'

export const ForgeUITerminalMenuButtons = (props: ForgeUiTerminalProps) => {
