...
import { EMPTY_BLOCK, KNOWN_TRANSACTION, ForgeUiTerminalProps, SET_ISVM, SET_OPEN, UNKNOWN_TRANSACTION, COPYABLE_VALUES } from './types/terminalTypes'
...
export const ForgeUiTerminal = (props: ForgeUiTerminalProps) => {
...
export default ForgeUiTerminal
