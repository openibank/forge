...
import './forge-ui-theme-module.module.css'

/* eslint-disable-next-line */
export interface ForgeUiThemeModuleProps {
  themeModule: ThemeModule
}

export function ForgeUiThemeModule({ themeModule }: ForgeUiThemeModuleProps) {
...
export default ForgeUiThemeModule
