...
import { DeployedContract } from '@creditchain/forge-ui/run-tab-deployed-contracts'
/**
    ...
    try {
      ...
      if (targetMode === 'inline') {
        try {
          ...
          // Get actual workspace name - on forge-desktop get the folder name from working directory
