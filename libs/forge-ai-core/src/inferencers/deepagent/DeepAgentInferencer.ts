...
import { CONVERSATION_THREAD_PREFIX, DAPP_MAX_TOKENS } from '@creditchain/forge-ai-core'
import { Features } from '@creditchain/forge-api'
import { flattenJSON, renderTree } from './helpers/project'
import { clearAllQuickDappWorkspaceLocks } from '@creditchain/forge-ui/helper'
...
export class DeepAgentInferencer implements ICompletions, IGeneration {
  ...
  //   import('@creditchain/forge-ai-core').then(m => m.DeepAgentInferencer.__gcStats())
