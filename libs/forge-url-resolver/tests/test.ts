...
describe('testRunner', () => {
  describe('# RemixResolve.resolve()', () => {
    describe('* test without AppManager', () => {
      ...
      //   const fileName: string = '../forge-url-resolver/tests/example_1/greeter.sol'
      //   let results: object = {}
      ...
      //       cleanUrl: '../forge-url-resolver/tests/example_1/greeter.sol',
      //       type: 'local'
      //     }
      ...
      describe('test getting github imports for specific branch', () => {
        const urlResolver = new RemixURLResolver()
        const fileName: string = 'https://github.com/openibank/forge/blob/remix_beta/libs/forge-url-resolver/tests/example_1/greeter.sol'
        let results: object = {}
        ...
        it('should return contract content of given github path', () => {
          const expt: object = {
            cleanUrl: 'openibank/forge/libs/forge-url-resolver/tests/example_1/greeter.sol',
      ...
      describe('test getting github imports for specific tag', () => {
        const urlResolver = new RemixURLResolver()
        const fileName: string = 'https://github.com/openibank/forge/blob/v0.10.7/libs/forge-url-resolver/tests/example_1/greeter.sol'
        let results: object = {}
      ...
      describe('test getting github imports for specific commit id', () => {
        const urlResolver = new RemixURLResolver()
        const fileName: string = 'https://github.com/openibank/forge/blob/d95b20d77bb3d41da4a86f3ff486879edb386a5b/libs/forge-url-resolver/tests/example_1/greeter.sol'
        let results: object = {}
