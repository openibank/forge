...
import { CompiledContract, CompilerAbstract } from '@creditchain/forge-solidity'
...
export class CompilerArtefacts extends Plugin {
  ...
  /**
   * Get compilation output for contracts compiled during a session of Forge IDE
  ...
  /**
   * filter compilation output for contracts compiled during a session of Forge IDE
   * @returns compilation output
   */
