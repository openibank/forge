...
import { RemixURLResolver, githubFolderResolver } from '@creditchain/forge-url-resolver'
        ...
        */
        ...
        if (exist) {
          ...
          if (localhostProvider.isConnected()) {
            ...
            // pick forge-tests library contracts from '.deps'
            if (url.startsWith('remix_')) possiblePaths.push('localhost/.deps/forge-tests/' + url)
