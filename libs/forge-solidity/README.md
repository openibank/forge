## Remix-Solidity
[![npm version](https://badge.fury.io/js/%40creditchain%2Fforge-solidity.svg)](https://www.npmjs.com/package/@creditchain/forge-solidity)
[![npm](https://img.shields.io/npm/dt/@creditchain/forge-solidity.svg?label=Total%20Downloads)](https://www.npmjs.com/package/@creditchain/forge-solidity)
[![npm](https://img.shields.io/npm/dw/@creditchain/forge-solidity.svg)](https://www.npmjs.com/package/@creditchain/forge-solidity)
[![GitHub](https://img.shields.io/github/license/mashape/apistatus.svg)](https://github.com/openibank/forge/tree/master/libs/forge-solidity)
...
`@creditchain/forge-solidity` is a tool to load and run solidity compiler. It works underneath Forge IDE  "Solidity Compiler" plugin which is used to load different versions of compiler and compile the smart contracts. 

### Installation

`@creditchain/forge-solidity` is an NPM package and can be installed using NPM as:

`yarn add @creditchain/forge-solidity`

### How to use

`@creditchain/forge-solidity` exports:
```
    {
        Compiler: Compiler,
...
```
`CompilerInput` can be used to form the [compiler input](https://github.com/openibank/forge/blob/master/libs/forge-solidity/src/compiler/types.ts#L1) by passing the [options](https://github.com/openibank/forge/blob/master/libs/forge-solidity/src/compiler/types.ts#L144)
