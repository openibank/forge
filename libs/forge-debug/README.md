## Remix Debug
[![npm version](https://badge.fury.io/js/%40creditchain%2Fforge-debug.svg)](https://www.npmjs.com/package/@creditchain/forge-debug)
[![npm](https://img.shields.io/npm/dt/@creditchain/forge-debug.svg?label=Total%20Downloads)](https://www.npmjs.com/package/@creditchain/forge-debug)
[![npm](https://img.shields.io/npm/dw/@creditchain/forge-debug.svg)](https://www.npmjs.com/package/@creditchain/forge-debug)
[![GitHub](https://img.shields.io/github/license/mashape/apistatus.svg)](https://github.com/openibank/forge/tree/master/libs/forge-debug)
...
`@creditchain/forge-debug` is a tool to debug Ethereum transactions on different Remix environments (VM, testnet etc.). It works underneath Forge IDE "DEBUGGER" plugin which is used to analyse step-to-step execution of a transaction to debug it.

### Installation
`@creditchain/forge-debug` is an NPM package and can be installed using NPM as:

`yarn add @creditchain/forge-debug`

### How to use

`@creditchain/forge-debug` can be used as:

```ts

var Debugger = require('forge-debug').EthDebugger
var BreakpointManager = require('forge-debug').BreakpointManager
